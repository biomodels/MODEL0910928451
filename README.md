...
`pip install git+https://github.com/biomodels/MODEL0910928451.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/MODEL0910928451.git@20140916`

## Usage

Importing the model package.

`import MODEL0910928451 as model`
...
version02**
](http://www.cellml.org/models/guyton_red_cells_and_viscosity_2008_version02)  
